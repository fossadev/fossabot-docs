...
**We use YouTube API Services to query data that powers this variable. Use of this variable is subject the [Google Privacy Policy](https://policies.google.com/privacy) and [YouTube Terms of Service](https://www.youtube.com/t/terms)**
